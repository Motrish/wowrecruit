...
class wowtbcrecruit_portal extends portal_generic
{
    ...
    public function get_settings($state)
    {
        $settings = array(
            ...
            'Fraction' => array(
                ...
                'class' => 'js_reload',
                'options' => array(
                    'recruit_Alliance' => $this
                        ->user
                        ->lang('recruit_Alliance') ,
                    'recruit_Horde' => $this
                        ->user
                        ->lang('recruit_Horde') ,
    ...
    public function output()
    {
        ...
        if ($this->config('Fraction') == 'recruit_Alliance')
        {
            $fraction = "alliance_logo.png";
        }
        if ($this->config('Fraction') == 'recruit_Horde')
        {
            $fraction = "horde_logo.png";
        }
        if ($this->config('Fraction') == 'recruit_Alliance')
        {
            $border = 'alliance';
...
<div class='recruitmentBox'>
	...
	<div class='classType' id='druid'>
		...
		<div class='className'>" . $this
            ->user
            ->lang("wowtbcrecruit_c_Class1") . "</div>
		<div class='classSpec " . $border . "' title='" . $this
            ->user
            ->lang("wowtbcrecruit_s_Class4") . "'>
	...
	<div class='classType' id='hunter'>
		...
		<div class='className'>" . $this
            ->user
            ->lang("wowtbcrecruit_c_Class2") . "</div>
		<div class='classSpec " . $border . "' title='" . $this
            ->user
            ->lang("wowtbcrecruit_s_Class7") . "'>
	...
	<div class='classType' id='mage'>
		...
		<div class='className'>" . $this
            ->user
            ->lang("wowtbcrecruit_c_Class3") . "</div>
		<div class='classSpec " . $border . "' title='" . $this
            ->user
            ->lang("wowtbcrecruit_s_Class10") . "'>
	...
	<div class='classType' id='paladin'>
		...
		<div class='className'>" . $this
            ->user
            ->lang("wowtbcrecruit_c_Class4") . "</div>
		<div class='classSpec " . $border . "' title='" . $this
            ->user
            ->lang("wowtbcrecruit_s_Class13") . "'>
	...
	<div class='classType' id='priest'>
		...
		<div class='className'>" . $this
            ->user
            ->lang("wowtbcrecruit_c_Class5") . "</div>
		<div class='classSpec " . $border . "' title='" . $this
            ->user
            ->lang("wowtbcrecruit_s_Class16") . "'>
	...
	<div class='classType' id='shaman'>
		...
		<div class='className'>" . $this
            ->user
            ->lang("wowtbcrecruit_c_Class6") . "</div>
		<div class='classSpec " . $border . "' title='" . $this
            ->user
            ->lang("wowtbcrecruit_s_Class19") . "'>
	...
	<div class='classType' id='rogue'>
		...
		<div class='className'>" . $this
            ->user
            ->lang("wowtbcrecruit_c_Class7") . "</div>
		<div class='classSpec " . $border . "' title='" . $this
            ->user
            ->lang("wowtbcrecruit_s_Class22") . "'>
	...
	<div class='classType' id='warlock'>
		...
		<div class='className'>" . $this
            ->user
            ->lang("wowtbcrecruit_c_Class8") . "</div>
		<div class='classSpec " . $border . "' title='" . $this
            ->user
            ->lang("wowtbcrecruit_s_Class25") . "'>
	...
	<div class='classType' id='warrior'>
		...
		<div class='className'>" . $this
            ->user
            ->lang("wowtbcrecruit_c_Class9") . "</div>
		<div class='classSpec " . $border . "' title='" . $this
            ->user
            ->lang("wowtbcrecruit_s_Class28") . "'>
